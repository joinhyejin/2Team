...
<body>
	<table style="width: 90%;">
		<tr>
			<td class="best" colspan="2">기타상품</td>
		...
		<table style="width: 70%;" class="intro">
			<tr>
				<td rowspan="10" align="center" width="60%"><img
					src="img/${all[0].photo }"
					style="object-fit: contain; width: 100%;"> <input
					type="hidden" value="${all[0].photo }" name="photo" id="photo">
				</td>
				<td colspan="3" align="center" id="Pname"><input id="name"
					name="name" type="hidden" value="${all[0].name }">${all[0].name }</td>
			</tr>
			<tr>
				<td colspan="3" align="center" id="Pprice"><input type="hidden"
					value="${all[0].price }" id="price" name="price"> <fmt:formatNumber
						type="currency">${all[0].price }</fmt:formatNumber></td>
			</tr>
			<tr>
				...
				<table>
					<tr>
						<td><img style="object-fit: contain; width: 100%;"
							src="${pageContext.request.contextPath}\img/${all[0].info}"></td>
					</tr>
