		...
		<table style="width: 70%;" class="intro">
			<tr>
				<td rowspan="10" align="center" width="60%"><img
					src="img/${all[3].photo }" style="object-fit: contain; width: 100%;">
					<input type="hidden" value="${all[3].photo }" name="photo"
					id="photo"></td>
				<td colspan="3" align="center" id="Pname"><input id="name"
					name="name" type="hidden" value="${all[3].name }">${all[3].name }</td>
			</tr>
			<tr>
				<td colspan="3" align="center" id="Pprice"><input type="hidden"
					value="${all[3].price }" id="price" name="price">
				...
				<table>
					<tr>
						<td><img style="object-fit: contain; width: 100%;"
							src="${pageContext.request.contextPath}\img/${all[3].info}"></td>
					</tr>
