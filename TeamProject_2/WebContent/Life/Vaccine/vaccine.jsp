...
<body>
	<table style="width: 90%;">
		<tr>
			<td class="best" colspan="2">생활 소도구</td>
			<td id="home" style="text-align: right;"><a href="HC">홈 > </a></td>
			<td id="all" style="text-align: right;"><a href="LifeC"
				id="all2">생활 소도구 ▼</a></td>
		</tr>
		...
		<table style="width: 70%;" class="intro">
			<tr>
				<td rowspan="10" align="center" width="60%"><img
					src="img/${all[1].photo }" style="object-fit: contain; width: 100%;">
					<input type="hidden" value="${all[1].photo }" name="photo" id="photo">
					</td>
				<td colspan="3" align="center" id="Pname"><input id="name"
					name="name" type="hidden" value="${all[1].name }">${all[1].name }</td>
			</tr>
			<tr>
				<td colspan="3" align="center" id="Pprice"><input type="hidden"
					value="${all[1].price }" id="price" name="price">
				...
				<table>
					<tr>
						<td><img style="object-fit: contain; width: 100%;"
							src="${pageContext.request.contextPath}\img/${all[1].info}"></td>
					</tr>
