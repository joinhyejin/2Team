...
<body>
	...
	<table style="width: 100%;">
		<tr>
			<!-- 임시 이미지 -->
			<td class="img2" align="center"><a href="${life[0].con }"><img
					style="object-fit: contain; width: 100%;"
					src="img/${life[0].photo }"></a></td>
		...
		<tr>
			<td class="best3"><fmt:formatNumber type="currency">${life[0].price }</fmt:formatNumber></td>
			<td class="best3"></td>
			<td class="best3"></td>
			<td class="best3"></td>
		</tr>
	...
	<table class="page_nus">
		<tr>
			<td id="page_nu"><a href="LifeC" id="page_nu">1</a></td>
		</tr>
	</table>
