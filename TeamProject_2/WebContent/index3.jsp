...
<body>
	<div class="wrap">
		...
		<div class="header">
			...
			<div class="logo">
				<h1>
					<a href="HC"> <span class="sol">솔데스크샵</span>
					</a>
				</h1>
			</div>
			<ul class="header_R">
				<li><a href="https://shopping.naver.com/my/keep-stores">찜한
						스토어</a></li>
		...
		<div class="menu-1">
			...
			<ul>
				<li><a href="AllC">전체상품</a></li>
				<li><a href="PersonC">인신매매</a>
					<ul class="nav_b">
						<li><a href="HjC">정혜진</a></li>
					</ul></li>
				<li><a href="LifeC">생활 소도구</a>
					<ul class="nav_b">
						<li><a href="VaccineC">밀-수입 코로나19</a></li>
					</ul></li>
				<li><a href="EtcC">기타상품</a>
					<ul class="nav_b">
						<li><a href="CatC">매우-귀여운 고양이</a></li>
						<li><a href="ShoesC">커플 슈-즈</a></li>
					</ul></li>
				<li><a href="SellerC">솔데스크샵</a>
					<ul class="nav_b">
