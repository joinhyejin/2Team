...
<body>
	<form action="BuyC">
        ...
        <li>
         <div class="show_img">
        <img src="img/${all[2].photo }"><input
					type="hidden" value="${all[2].photo }" name="photo" id="photo">
        </div>
        </li>
        ...
        <h5>(주)솔데스크샵</h5>
        <h2 ><input id="name"
		name="name" type="hidden" value="${all[2].name }">"${all[2].name }" </h2>
        ...
        <h2><input type="hidden"
					value="${all[2].price }" id="price" name="price"> <fmt:formatNumber
						type="currency">${all[2].price }</fmt:formatNumber></h2>
        </div>
