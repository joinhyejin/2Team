...
<body>
	<form action="BuyC">
        ...
        <li>
         <div class="show_img">
        <img src="img/${all[3].photo }"><input
					type="hidden" value="${all[3].photo }" name="photo" id="photo">
        </div>
        </li>
        ...
        <h5>(주)솔데스크샵</h5>
        <h2 ><input id="name"
		name="name" type="hidden" value="${all[3].name }">"${all[3].name }" </h2>
        ...
        <h2><input type="hidden"
					value="${all[3].price }" id="price" name="price"> <fmt:formatNumber
						type="currency">${all[3].price }</fmt:formatNumber></h2>
        </div>
