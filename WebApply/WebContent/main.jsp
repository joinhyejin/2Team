	...
	<div class="slider">
		...
		<ul id="imgholder" class="imgs">
			<c:forEach var="a" items="${all }">
				<li><a href=${a.con }><img src="img/${a.photo }"></a></li>
			</c:forEach>
		</ul>
		<div class="bullets">
	...
	<div class="main_section">
		...
		<section class="mainBG">
			<div class="container">
				<a href="SellerC">
					<div>
						<h1 class="main_tit">
							<span> The Finest Quality group members</span> <br>Soldesk
							Project STORY
						</h1>
						<p>
							단 기간 최고의 효율을 낸 솔데스크샵을 만나보세요. <br> 마음에 드시는 상품을 구매해 주세요.
						</p>
					</div>
				</a>
				<div>&nbsp;&nbsp;</div>
		...
		<section class="mainBG2">
			<div class="inner">
				...
				<div class="cat">
					<a href=${all[0].con }> <img src="img/고양이.png"></a>
				</div>
			</div>
		</section>
